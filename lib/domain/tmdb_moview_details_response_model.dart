...
TmdbMovieDetailsResponseModel tmdbMovieDetailsResponseModelFromJson(String str) => TmdbMovieDetailsResponseModel.fromJson(json.decode(str));

String tmdbMovieDetailsResponseModelToJson(TmdbMovieDetailsResponseModel data) => json.encode(data.toJson());

class TmdbMovieDetailsResponseModel {
  bool? adult;
  String? backdropPath;
  ...
  factory TmdbMovieDetailsResponseModel.fromJson(Map<String, dynamic> json) => TmdbMovieDetailsResponseModel(
    adult: json["adult"],
